...
import 'package:flutter/services.dart'; // Import for handling JavaScript channels
...
class _CartPageState extends State<CartPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: showWebView
          ? WebView(
              initialUrl: 'http://192.168.1.70:8000', // Replace with your URL
              ...
              onPageFinished: (initialUrl) {
                ...
                _webViewController.runJavascript(
                    'window.flutter_inappwebview.postMessage("Hello from Flutter!");');
              },
            )
          : Stack(
              children: [
                      ...
                      GestureDetector(
                        onTap: () {
                          if (Get.find<AuthController>().userLoggedIn()) {
                            ...
                            // Send a message to JavaScript when showing WebView
                            _webViewController.runJavascript(
                              'sendToFlutter("PaymentSuccessful")',
                            );
                          } else {
